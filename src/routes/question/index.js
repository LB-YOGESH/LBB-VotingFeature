...
router.put(
  "/upVote/id=:questionId&downVote=:downVote&upVote=:upVote",
  passport.authenticate(["jwt"], { session: false }),
  validate("body", api4Question.upVoteQuestion.validation),
  api4Question.upVoteQuestion.handler
);
router.put(
  "/downVote/id=:questionId&downVote=:downVote&upVote=:upVote",
  passport.authenticate(["jwt"], { session: false }),
  validate("body", api4Question.downVoteQuestion.validation),
